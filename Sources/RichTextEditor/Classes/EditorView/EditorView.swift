...
/// Composite view containing RichTextEditor for visual editing and an HTML editor view.
///
public class EditorView: UIView {
    ...
    static let htmlTextViewKey = "EditorView.htmlTextView"
    static let richTextViewKey = "EditorView.richTextView"
