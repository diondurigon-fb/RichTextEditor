...
public struct Element: RawRepresentable, Hashable {
    ...
    ///
    public static var blockLevelElements: Set<Element> = Set([.address, .htmlRootNode, .blockquote, .div, .dl, .dd, .dt, .fieldset, .figure, .figcaption, .form, .h1, .h2, .h3, .h4, .h5, .h6, .hr, .li, .noscript, .ol, .p, .pre, .table, .td, .tr, .ul])
...
extension Element {
    static let htmlRootNode = Element("htmltag.rootnode")
}
