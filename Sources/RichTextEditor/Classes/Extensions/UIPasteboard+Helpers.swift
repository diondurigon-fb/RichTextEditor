...
extension UIPasteboard {
    ...
    func attributedString() -> NSAttributedString? {
        ...
        if let string = richTextEditorAttributedString() {
            return string
        }
...
private extension UIPasteboard {
    ...
    /// Attempts to unarchive the Pasteboard's RichTextEditor-Archived String
    ///
    private func richTextEditorAttributedString() -> NSAttributedString? {
