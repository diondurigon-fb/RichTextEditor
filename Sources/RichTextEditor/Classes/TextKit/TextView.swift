...
open class TextView: UITextView {
    ...
    ///
    open var pasteboardDelegate: TextViewPasteboardDelegate = RichTextViewPasteboardDelegate()
    ...
    // MARK: - TextKit RichTextEditor Subclasses
    ...
    private func setupLayoutManager() {
        guard let richTextEditorLayoutManager = layoutManager as? LayoutManager else {
            return
        }

        richTextEditorLayoutManager.extraLineFragmentTypingAttributes = { [weak self] in
