...
class TextViewTests: XCTestCase {
    ...
    func createTextViewWithContent() -> TextView {
        ...
        let richTextView = RichTextEditor.TextView(defaultFont: UIFont.systemFont(ofSize: 14), defaultMissingImage: UIImage())
    ...
    func testTextViewReferencesStorage() {
        ...
        let textView = RichTextEditor.TextView(defaultFont: UIFont.systemFont(ofSize: 14), defaultMissingImage: UIImage())
    ...
    /// https://github.com/wordpress-mobile/WordPress-RichTextEditor-iOS/issues/350
    ///
    ...
    /// https://github.com/wordpress-mobile/WordPress-RichTextEditor-iOS/issues/352
    ///
    ...
    ///
    /// Added to avoid regressions to the bug reported here:
    /// https://github.com/wordpress-mobile/WordPress-RichTextEditor-iOS/issues/387
    ///
    ...
    /// https://github.com/wordpress-mobile/RichTextEditorEditor-iOS/issues/457
    ///
    ...
    ///
    /// Ref.: https://github.com/wordpress-mobile/WordPress-RichTextEditor-iOS/issues/404
    ///
    ...
    ///
    /// Ref. https://github.com/wordpress-mobile/WordPress-RichTextEditor-iOS/issues/407
    ///
    ...
    /// Ref. https://github.com/wordpress-mobile/RichTextEditorEditor-iOS/issues/466
    ///
    ...
    ///     - Backspace
    ///
    /// Ref. Scenario Mark I on Issue https://github.com/wordpress-mobile/RichTextEditorEditor-iOS/pull/425
    ///
    ...
    ///     - Backspace
    ///
    /// Ref. Scenario Mark II on Issue https://github.com/wordpress-mobile/RichTextEditorEditor-iOS/pull/425
    ///
    ...
    ///
    /// Ref. Scenario Mark III on Issue https://github.com/wordpress-mobile/RichTextEditorEditor-iOS/pull/425
    ///
    ...
    ///
    /// Ref. Scenario Mark IV on Issue https://github.com/wordpress-mobile/RichTextEditorEditor-iOS/pull/425
    ///
    ...
    ///     - Selection of the `\n` at the EOD
    ///
    /// Ref. Scenario Mark V on Issue https://github.com/wordpress-mobile/RichTextEditorEditor-iOS/pull/425
    ///
    ...
    ///     - Unordered List
    ///
    /// Ref. Issue https://github.com/wordpress-mobile/RichTextEditorEditor-iOS/issues/414
    ///
    ...
    ///     Line 3: <empty>
    ///
    /// RichTextEditor tends to naturally maintain the list style alive, due to the newline between line 2 and
    ...
    /// https://github.com/wordpress-mobile/RichTextEditorEditor-iOS/issues/594
    ///
    ...
    ///
    /// Related issue:
    /// https://github.com/wordpress-mobile/RichTextEditorEditor-iOS/issues/1012
    ///
    ...
    ///     - Backspace
    ///
    /// Ref. Issue https://github.com/wordpress-mobile/RichTextEditorEditor-iOS/issues/422
    ///
    ...
    ///     - Backspace
    ///
    /// Ref. Issue https://github.com/wordpress-mobile/RichTextEditorEditor-iOS/issues/420
    ///
    ...
    ///
    func testCopyDoesNotCauseRichTextEditorToCrash() {
    ...
    /// Ref. Issue #626: NSKeyedArchiver Crash
    ///
    func testCutDoesNotCauseRichTextEditorToCrash() {
        let textView = TextViewStub(withSampleHTML: true)
        textView.selectedRange = textView.storage.rangeOfEntireString
        textView.cut(nil)
    }
    ...
    /// doesn't cause RichTextEditor to crash.
    ///
    func testWritingIntoAnEmptyPasteboardDoesNotCauseRichTextEditorToCrash() {
    ...
    func testHRPeristsAfterRichTextEditor() {
...
"""
    ...
    func testEmptyListsPersistsAfterRichTextEditor() {
