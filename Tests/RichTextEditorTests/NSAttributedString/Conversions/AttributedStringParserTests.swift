...
class AttributedStringParserTests: XCTestCase {
    ...
    ///
    /// - Input: <h1>RichTextEditor Rocks</h1>\nNewline?
    ///
    /// - Output: <h1>RichTextEditor Rocks</h1>Newline?
    ///
    func testHeaderElementGetsProperlySerialiedBackIntoItsHtmlRepresentation() {
        ...
        for level in levels {
            ...
            let headingText = NSAttributedString(string: "RichTextEditor Rocks\n", attributes: headingStyle)
            ...
            XCTAssertEqual(headerTextNode.contents, "RichTextEditor Rocks")
...
"""
    ...
    func testPreParagraphsAreMergedRight() {
        ...
        // RichTextEditor normalizes newlines to paragraph separators.
