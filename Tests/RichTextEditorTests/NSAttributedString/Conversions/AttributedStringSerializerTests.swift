...
class AttributedStringSerializerTests: XCTestCase {
    ...
    func testMultipleSpanNodesAreProperlyPreservedWithinUnsupportedHtmlAttribute() {
        ...
        // <span class="RichTextEditor"></span>
        let spanAttribute2 = Attribute(type: .class, value: .string("RichTextEditor"))
        let spanNode2 = ElementNode(type: .span, attributes: [spanAttribute2], children: [textNode])

        // <span class="first"><span class="RichTextEditor"></span>
        ...
        // <h1><span class="first"><span class="RichTextEditor"></span></span></h1>
        ...
        XCTAssertEqual(restoredSpanAttribute2?.value.toString(), "RichTextEditor")
    ...
    func testLineBreakTagWithinHTMLDivGetsProperlyEncodedAndDecoded() {
        let inHtml = "<div><br>RichTextEditor, don't forget me!</div>"
    ...
    func testLineBreakTagWithinUnsupportedHTMLDoesNotCauseDataLoss() {
        let inHtml = "<span><br>RichTextEditor, don't forget me!</span>"
        let expectedHtml = "<p><span><br>RichTextEditor, don't forget me!</span></p>"
